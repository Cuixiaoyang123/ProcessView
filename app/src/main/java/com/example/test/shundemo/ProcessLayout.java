...
//                    setTranslationX(getTranslationX()+((event.getRawX() > tempPointX)? 10f : -10f));
//                    setTranslationY(getTranslationY()+((event.getRawY() > tempPointY)? 10f : -10f));
...
//        box.setPadding(300,200,0,0);
//        RelativeLayout.LayoutParams lp = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
//        RelativeLayout.LayoutParams lp = new RelativeLayout.LayoutParams(box.getLayoutParams());
//        new LayoutParams
//        lp.leftMargin = 600;
//        lp.topMargin = 300;
...
//        layoutParams.addRule(RelativeLayout.ABOVE, R.id.btn_export);
//
...
//            ProcessBox box = next.getValue();
//            if (rect.contains((int) box.dstPs[6], (int) box.dstPs[7])) {
//                return new int[]{CTR_RIGHT_MID, next.getKey().hashCode(), (int) box.dstPs[6], (int) box.dstPs[7]};
//            } else if (rect.contains((int) box.dstPs[14], (int) box.dstPs[15])) {
//                return new int[]{CTR_LEFT_MID, -1, (int) box.dstPs[14], (int) box.dstPs[15]};
//            }
//        }
...
//                                                editText.setLayoutParams(layoutParams);
        ...
        builder.show();
//        new ProcessDirectionLine.LineCallBack() {
//            @Override
